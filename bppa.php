    ...
    <!-- Navbar -->
        ...
        <section class="vh-100">
            <div class="container-md">
                <h2><b>Senarai Aduan Kerosakan Aset </b>( <?php echo $row_akaun['emel'] ?> )</h2>
                <div class="table-responsive-sm">
                    ...
                    <table class="table">
                        ...
                        <?php
                        include('db.php');
                        $sql = "SELECT * FROM tbl_semakan WHERE role='".$row_akaun['role']."'";
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="view_staff.php?no_id=<?php echo $data['no_id'];?>" class="btn btn-info my-1">Lebih lanjut</a>
                                <a href="edit_bppa.php?no_id=<?php echo $data['no_id'];?>" class="btn btn-warning">Edit</a>
                            </td>
                        </tr>
                        <?php
                            }
