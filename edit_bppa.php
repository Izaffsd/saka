...
<body>
    <div class="container my-5">
        <header class="d-flex justify-content-between my-4">
            ...
            <div>
                <a href="bppa.php" class="btn btn-primary">Kembali</a>
            </div>
        </header>
        <style>
            body {
        ...
        <form action="process_edit.php" method="POST">
            ...
            if (isset($_GET['no_id'])) {
                ...
                <div class="form-element my-4">
                <input type="text" class="form-control" name="jenis_aset" placeholder="Jenis Asset" value="<?php echo $row["jenis_aset"]; ?>" required>
                </div>
                ...
                <!-- <div class="form-element my-4">
                    ...
                    <div class="form-element my-4">
                        <input type="text" class="form-control" name="no_siri" placeholder="Nombor Siri Pendaftaran" value="<?php echo $row["no_siri"]; ?>">
                    </div>

                    <div class="form-element my-4">
                    <input type="text" class="form-control" name="tempat_rosak" placeholder="Tempat Kerosakan" value="<?php echo $row["tempat_rosak"]; ?>" required>
                    </div>
                    ...
                    <div class="form-element my-4">
                            <select name = "lulus_jabatan" class="form-control" required>
                                <option name="lulus_jabatan" value="Dalam Proses">Dalam Proses</option>
